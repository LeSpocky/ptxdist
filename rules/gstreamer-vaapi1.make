...
# Paths and names
#
GSTREAMER_VAAPI1_VERSION	:= 1.26.8
GSTREAMER_VAAPI1_MD5		:= 45c517ebbd0fae31c514ddf6178c2713
GSTREAMER_VAAPI1		:= gstreamer-vaapi-$(GSTREAMER_VAAPI1_VERSION)
GSTREAMER_VAAPI1_SUFFIX		:= tar.xz
GSTREAMER_VAAPI1_URL		:= https://gstreamer.freedesktop.org/src/gstreamer-vaapi/$(GSTREAMER_VAAPI1).$(GSTREAMER_VAAPI1_SUFFIX)
