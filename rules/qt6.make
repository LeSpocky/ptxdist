...
QT6_LIBS-$(PTXCONF_QT6_MODULE_QT3D_QUICK)			+= Qt63DQuick Qt63DQuickAnimation Qt63DQuickExtras Qt63DQuickInput Qt63DQuickRender Qt63DQuickScene2D Qt63DQuickScene3D
...
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE)			+= Qt6QmlCompiler
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE)			+= Qt6QmlCore
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE)			+= Qt6QmlLocalStorage
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE)			+= Qt6QmlMeta
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE)			+= Qt6QmlNetwork
...
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickControls2Basic
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickControls2BasicStyleImpl
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickControls2Impl
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickControls2Universal
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickControls2UniversalStyleImpl
...
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickControls2FluentWinUI3StyleImpl
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickControls2Fusion
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickControls2FusionStyleImpl
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickControls2Imagine
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickControls2ImagineStyleImpl
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickLayouts
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QUICK)		+= Qt6QuickControls2Material
...
QT6_PLUGINS-$(PTXCONF_QT6_MODULE_QTDECLARATIVE_QTQUICK3D_DEBUG)	+= qmltooling/libqmldbg_quick3dprofiler
QT6_QML-$(PTXCONF_QT6_MODULE_QTDECLARATIVE)			+= Qt
QT6_QML-$(PTXCONF_QT6_MODULE_QTDECLARATIVE)			+= QtCore
QT6_QML-$(PTXCONF_QT6_MODULE_QTDECLARATIVE)			+= QtNetwork
...
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTGRAPHS_WIDGETS)			+= Qt6GraphsWidgets
...
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTQUICK3D)			+= Qt6Quick3DXr
...
QT6_LIBS-$(PTXCONF_QT6_MODULE_QTQUICKTIMELINE)			+= Qt6QuickTimelineBlendTrees
