...
world/env/impl = \
	...
	pkg_cve_product="$(call ptx/escape,$($(1)_CVE_PRODUCT))"		\
	pkg_cve_version="$(call ptx/escape,$($(1)_CVE_VERSION))"		\
	...
	pkg_parts="$(words $(call ptx/escape,$($(1)_PARTS)))"			\
	pkg_src="$(call ptx/escape,$($(1)_SOURCE))"				\
	pkg_srcs="$(call ptx/escape,$($(1)_SOURCES))"				\
	pkg_md5s="$(call ptx/escape,$(if $(strip $(foreach s,$($(1)_PARTS),$($(s)_MD5))),$(foreach s,$($(1)_PARTS),$($(s)_MD5):)))" \
	pkg_md5="$(call ptx/escape,$($(1)_MD5))"				\
	pkg_sha256s="$(call ptx/escape,$(if $(strip $(foreach s,$($(1)_PARTS),$($(s)_SHA256))),$(foreach s,$($(1)_PARTS),$($(s)_SHA256):)))" \
